  ...
  const rendereventclick = () => {
    return (
      <form className="event-form">
        <label>Cambiar nombre de Tarea</label>
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="form-group">
              <label className="control-label">Nombre de Tarea: </label>
              <input
                className="form-control"
                type="text"
                name="title"
      ...
      <div className="content container-fluid">
        ...
        <div className="page-header">
          <div className="row align-items-center">
            <div className="col">
              <h3 className="page-title">Calendario de Tareas</h3>
            ...
            <div className="col-auto text-right float-right ml-auto">
              <a href="#" onClick={addEvent} className="btn btn-primary">
                Crear Tarea
              </a>
            </div>
          </div>
        ...
        <div className="row">
          <div className="col-lg-3 col-md-4">
            <h4 className="card-title">Tarea de Arrastrar y Soltar</h4>
            <div id="calendar-events" className="mb-3">
              <div className="calendar-events">
                <i className="fas fa-circle text-info"></i> Mi Tarea Uno
              </div>
              <div className="calendar-events">
                <i className="fas fa-circle text-success"></i> Mi Tarea Dos
              </div>
              <div className="calendar-events">
                <i className="fas fa-circle text-danger"></i> Mi Tarea Tres
              </div>
              <div className="calendar-events">
                <i className="fas fa-circle text-warning"></i> Mi Tarea Cuatro
              </div>
            </div>
            <div className="checkbox  mb-3">
              <input id="drop-remove" type="checkbox" />
              <label>Quitar después de soltar</label>
            </div>
            <a
              href="#0"
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form>
                  ...
                  <div className="form-group">
                    <label>
                      Fecha de Tarea <span className="text-danger">*</span>
                    </label>
        ...
        <Modal centered show={showEvents} onHide={handleClose}>
          ...
          <Modal.Body>
            <form>
              ...
              <div className="submit-section">
                <button className="btn btn-primary submit-btn">Guardar</button>
              </div>
            </form>
          </Modal.Body>
        </Modal>
        ...
        <Modal centered show={showCategory} onHide={handleClose}>
          <Modal.Header>
            <h4 className="modal-title">Agregar Categoría</h4>
            <button
              type="button"
              className="close"
              data-dismiss="modal"
          ...
          <Modal.Body>
            <form>
              ...
              <div className="form-group mb-0">
                <label>Escoge el Color de Categoría</label>
                <select
                  className="form-control form-white"
                  data-placeholder="Elige un color..."
                  name="category-color"
                >
        ...
        <Modal centered show={iseditdelete} onHide={handleClose}>
          <Modal.Header>Tarea</Modal.Header>
